...
SRVAllocationPage::SRVAllocationPage(DescriptorAllocation_D12& descAlloc) noexcept : m_memAllocation {std::move(descAlloc)} {
    m_slotFree.resize(m_memAllocation.GetNumHandles(), true);
    m_nextSlot = 0;
}


SRVAllocationPage::SRVAllocationPage(SRVAllocationPage&& otherAlloc) noexcept : 
